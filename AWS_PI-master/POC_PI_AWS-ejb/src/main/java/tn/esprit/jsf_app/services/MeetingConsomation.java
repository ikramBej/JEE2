...
return nbmeetingtoday;    	
   ...
   return lasp;    	
    ...
    {
    String uri = "http://localhost:6795/api/Meeting/Create";
    ...
    public  void deleteMeeting(Integer id) {
    	...
    	Client client = ClientBuilder.newClient();
    	WebTarget webTarget = client.target("http://localhost:6795/api/MeetingWebApi/"+id);
 ...
 public void updateMeeting(Meeting m, int id) {
    	...
    	Client client = ClientBuilder.newClient();
		WebTarget target = client.target("http://localhost:6795/api/Meeting/Update?MeetingId="+id);
